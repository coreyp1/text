/**
 * @file csv_file_io.c
 * @brief CSV file I/O example demonstrating option changes between steps
 *
...
int main(void) {
    ...
    // ========================================================================
    // Step 2: Write CSV to file with trailing newline enabled
    // ========================================================================
    printf("=== Step 2: Writing CSV to file (with trailing newline) ===\n");
    ...
    // ========================================================================
    // Step 3: Read CSV back from file
    // ========================================================================
    printf("=== Step 3: Reading CSV from file ===\n");
    ...
    // Parse with same options as step 1 (defaults)
    ...
    // ========================================================================
    // Step 4: Print CSV to stdout with different options (quote all fields)
    // ========================================================================
    printf("=== Step 4: Printing CSV to stdout (with quote_all_fields) ===\n");
