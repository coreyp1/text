...
**Tests.** 73 test files under `tests/yaml/`, carrying 521 of the suite's
2106 test cases across 85 binaries, all passing. They cover the scalar styles,
...
field, checked by value, and those marked `fail`, checked by refusal - **341
pass, 93.2%**. The other 38 assert an event stream the harness does not emit.
