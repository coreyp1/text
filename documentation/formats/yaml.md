...
**Tests.** 72 test files under `tests/yaml/`, carrying 519 of the suite's
2104 test cases across 82 binaries, all passing. They cover the scalar styles,
...
field, checked by value, and those marked `fail`, checked by refusal - **340
pass, 92.9%**. The other 38 assert an event stream the harness does not emit.
