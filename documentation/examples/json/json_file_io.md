...
JSON file I/O example demonstrating option changes between steps

## Use Case

See the source code comments and implementation for details.

## Source Code

@include examples/json/json_file_io.c
