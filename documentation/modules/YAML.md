...
parser. It passes **95.6%** of the 366 cases that can be checked by value or
...
hundred and sixty cases since came from quoted-scalar line folding,
...
The parser targets YAML 1.2.2 and hits **95.6%** of the
