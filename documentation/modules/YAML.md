...
parser. It passes **98.1%** of the 366 cases that can be checked by value or
...
hundred and sixty-nine cases since came from quoted-scalar line folding,
...
The parser targets YAML 1.2.2 and hits **98.1%** of the
