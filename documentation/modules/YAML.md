...
parser. It passes **97.0%** of the 366 cases that can be checked by value or
...
hundred and sixty-five cases since came from quoted-scalar line folding,
...
**Verified:** the suite runs 2118 tests across 91 binaries with zero
...
The YAML module is covered by 79 test files, part of a suite that runs
2118 tests across 91 binaries with zero failures. They cover:
...
The parser targets YAML 1.2.2 and hits **97.0%** of the
...
**Test count:** 533 YAML test cases, of 2118 across the suite, all passing
