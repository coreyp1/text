...
parser. It passes **83.6%** of the 366 cases that can be checked by value or
...
hundred and fifteen cases since came from quoted-scalar line folding,
...
white space, a group of positional rules, and a group around documents and
anchors. There are no benchmarks.
...
The parser targets YAML 1.2.2 and hits **83.6%** of the
