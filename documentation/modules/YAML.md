...
parser. It passes **92.1%** of the 366 cases that can be checked by value or
...
a group about where a line may begin, and the empty node. There are no
benchmarks.
...
The parser targets YAML 1.2.2 and hits **92.1%** of the
