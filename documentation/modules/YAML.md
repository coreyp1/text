...
parser. It passes **96.7%** of the 366 cases that can be checked by value or
...
hundred and sixty-four cases since came from quoted-scalar line folding,
...
**Verified:** the suite runs 2115 tests across 90 binaries with zero
...
The YAML module is covered by 78 test files, part of a suite that runs
2115 tests across 90 binaries with zero failures. They cover:
...
The parser targets YAML 1.2.2 and hits **96.7%** of the
...
**Test count:** 530 YAML test cases, of 2115 across the suite, all passing
