...
parser. It passes **94.8%** of the 366 cases that can be checked by value or
...
hundred and fifty-seven cases since came from quoted-scalar line folding,
...
the JSON they already are. There are no benchmarks.

**Verified:** the suite runs 2112 tests across 87 binaries with zero
...
The YAML module is covered by 75 test files, part of a suite that runs
2112 tests across 87 binaries with zero failures. They cover:
...
The parser targets YAML 1.2.2 and hits **94.8%** of the
...
**Test count:** 527 YAML test cases, of 2112 across the suite, all passing
